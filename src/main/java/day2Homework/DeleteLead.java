...
public class DeleteLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if(sNoRecord.equals("No records to display"))
			System.out.println("Verified 'No records to display'This message confirms the successful deletion");
		else
			System.out.println("Verification Failed 'No records to display' Text is not Displayed");
		driver.close();
	}
